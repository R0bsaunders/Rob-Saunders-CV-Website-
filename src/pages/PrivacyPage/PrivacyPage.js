        ...
        <div className="format-html">
          <div className="outputVersion1" data-exp="simple2">
            ...
            <p className="documentTitle">
              <span>www.rob-saunders.com</span>
            </p>
            ...
            <p>
              www.rob-saunders.com (the "Site") is owned and operated by
            ...
            <p>
              ...
              <br />
              <br />
              <span id="emailAddress2" className="revealEmailSpan">
                <button
                  data-id="emailAddress2"
                  className="btn btn-primary btn-lg navCTA"
                  onClick={printEmail}
                >
                  Reveal Email
