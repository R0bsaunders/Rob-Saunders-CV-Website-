    ...
    <main>
      ...
      <section id="work">
        <div className="container px-4 py-5" id="custom-cards">
          ...
          <h2 className="pb-2 border-bottom">My Development Portfolio - JavaScript, React, HTML and CSS</h2>

          <p>I have developed (pardon the pun &#x1F606;) a LOVE for coding and finding code-based solutions to real-world problems - something I have a good eye for. Here are a few of my web-development projects to date. They include projects I completed as part of my bootcamp, as well as my fully-bespoke custom line-by-line coded projects on the side:</p>
